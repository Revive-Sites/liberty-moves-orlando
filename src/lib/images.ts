...
// All entries visually verified as real photos (not logos).
// Badge/logo hashes 697201df (BBB), 697202f5 (Chamber), 697200c8 (OMC) are NOT used here.
export const IMG = {
  ...
  lobbyMove: { hash: '696908c7f43f8a25f73b23b2', ext: 'jpeg' as const }, // hi-rise lobby dolly move
  apartmentMove: { hash: '6967ea1ec802d94ad6138835', ext: 'png' as const }, // green shirt mover
  truckRamp: { hash: '696675210475d420a14bbe91', ext: 'png' as const }, // two movers loading truck
