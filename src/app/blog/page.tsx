...
const STATIC_POSTS: Post[] = [
  { slug: 'how-professional-packing-services-protect-your-belongings-during-a-move', title: 'How Professional Packing Services Protect Your Belongings During a Move', excerpt: 'Why pro packing dramatically reduces move-day damage — materials, methods, liability differences.', date: 'April 2026', category: 'Packing' },
  { slug: 'what-makes-liberty-moves-orlando-different-why-every-resident-deserves-the-best-in-2026', title: 'What Makes Liberty Moves Orlando Different in 2026', excerpt: 'Why Orlando residents keep choosing Liberty Moves — transparent pricing, real crews, real accountability.', date: 'March 2026', category: 'Company' },
  { slug: 'orlando-movers-the-real-difference-between-licensed-and-unlicensed', title: 'Orlando Movers: The Real Difference Between Licensed and Unlicensed', excerpt: 'What licensing actually protects you from — and the FLDACS/USDOT lookup tools you should use.', date: 'March 2026', category: 'Buyer Guide' },
  { slug: 'how-hiring-local-movers-makes-relocation-quick-and-easy', title: 'How Hiring Local Movers Makes Relocation Quick and Easy', excerpt: 'Why local Orlando crews outperform national chains — speed, familiarity, pricing.', date: 'February 2026', category: 'Local' },
  { slug: 'what-you-need-to-know-about-long-distance-moving-services', title: 'What You Need to Know About Long Distance Moving Services', excerpt: 'Interstate moving demystified — licensing, pricing, timing, and what to expect.', date: 'February 2026', category: 'Long Distance' },
