  ...
  return (
    <>
      ...
      <BreadcrumbsLd items={[
        ...
        { name: "How Professional Packing Services Protect Your Belongings Du", url: `${SITE.url}/blog/how-professional-packing-services-protect-your-belongings-during-a-move` },
      ]} />
