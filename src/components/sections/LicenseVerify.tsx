        ...
        <div className="rounded-2xl bg-gradient-to-br from-[var(--color-primary)] to-[#0f2344] text-white overflow-hidden">
          <div className="p-8 md:p-10 grid md:grid-cols-[auto_1fr] gap-6 items-start">
            ...
            <div>
              ...
              <h2 className="mt-2 text-2xl md:text-3xl font-extrabold">Don\u2019t just take our word for it. Verify for yourself.</h2>
              ...
              <div className="mt-6 pt-6 border-t border-white/10 grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                <div>
                ...
                <div>
                  ...
                  <div className="mt-1 font-bold">{SITE.legalName}</div>
                </div>
              </div>
            </div>
          </div>
