  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute inset-0 bg-gradient-to-br from-[#0a1729]/95 via-[#1e3a5f]/80 to-[#0a1729]/85"/>
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_right,rgba(245,158,11,0.18),transparent_60%)]"/>
      </div>
